...
describe('PersonalRecordsController', () => {
   ...
   it('delegates findOne to the service', async () => {
      personalRecordsServiceMock.findOne.mockResolvedValue(
         personalRecordRecord,
      );
      ...
      expect(personalRecordsServiceMock.findOne).toHaveBeenCalledWith(
         currentUser,
         personalRecordRecord.id,
      );
      expect(result).toEqual(personalRecordRecord);
   ...
   it('delegates update to the service', async () => {
      ...
      expect(personalRecordsServiceMock.update).toHaveBeenCalledWith(
         currentUser,
         personalRecordRecord.id,
         { value: 125 },
      );
   ...
   it('delegates remove to the service', async () => {
      ...
      expect(personalRecordsServiceMock.remove).toHaveBeenCalledWith(
         currentUser,
         personalRecordRecord.id,
      );
      expect(result).toEqual(personalRecordRecord);
