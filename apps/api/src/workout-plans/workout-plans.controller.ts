...
export class WorkoutPlansController {
   ...
   @Get()
   findAll(@CurrentUser() user: AuthenticatedUser, @Query('userId') userId: string): Promise<WorkoutPlanResponseDto[]> {
   ...
   @Get(':id')
   findOne(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string): Promise<WorkoutPlanResponseDto> {
   ...
   @Patch(':id')
   update(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string, @Body() updateWorkoutPlanDto: UpdateWorkoutPlanDto): Promise<WorkoutPlanResponseDto> {
   ...
   @ApiNotFoundResponse({ description: 'Plan de entrenamiento no encontrado.' })
   @Delete(':id')
   remove(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string): Promise<WorkoutPlanResponseDto> {
