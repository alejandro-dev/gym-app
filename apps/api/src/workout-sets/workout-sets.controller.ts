...
export class WorkoutSetsController {
   ...
   @Get()
   findAll(@CurrentUser() user: AuthenticatedUser, @Query('userId') userId: string): Promise<WorkoutSetResponseDto[]> {
   ...
   @Get(':id')
   findOne(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string): Promise<WorkoutSetResponseDto> {
   ...
   @Patch(':id')
   update(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string, @Body() updateWorkoutSetDto: UpdateWorkoutSetDto): Promise<WorkoutSetResponseDto> {
   ...
   @ApiNotFoundResponse({ description: 'Serie de entrenamiento no encontrada.' })
   @Delete(':id')
   remove(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string): Promise<WorkoutSetResponseDto> {
