...
describe('ExercisesController', () => {
	...
	describe('create', () => {
		it('delegates to exercisesService.create', async () => {
			...
			const result = await (controller as any).create(createExerciseDto);

			expect(exercisesServiceMock.create).toHaveBeenCalledWith(createExerciseDto);
	...
	describe('findOne', () => {
		it('delegates to exercisesService.findOne', async () => {
			...
			const result = await (controller as any).findOne(exerciseRecord.id);
	...
	describe('remove', () => {
		it('delegates to exercisesService.remove', async () => {
			...
			const result = await (controller as any).remove(exerciseRecord.id);
