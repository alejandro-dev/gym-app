...
interface DeleteWorkoutSessionDialogProps {
   visible: boolean;
   workoutSession: Pick<WorkoutSessionFeedItem, 'id' | 'name'> | null;
   isDeleting: boolean;
   close: () => void;
   onConfirm: () => void;
}
...
export const DeleteWorkoutSessionDialog = function DeleteWorkoutSessionDialog({
   visible,
   workoutSession,
   isDeleting,
   close,
         ...
         >
            ...
            <Dialog.Content>
               <Text style={styles.description}>
                  {workoutSession
                     ? `Se eliminará permanentemente "${workoutSession.name}". Esta acción no se puede deshacer.`
            ...
            <Dialog.Actions>
               <View style={styles.viewContainer}>
                  <Button
                     ...
                     onPress={onConfirm}
                  >
                     {isDeleting ? 'Eliminando...' : 'Borrar entrenamiento'}
                  </Button>
