import { Exercise, ExerciseCategory, ExercisesListResponse, MuscleGroup } from "@gym-app/types";
...
export function buildExercisesSearchPath(params: SearchExercisesParams = {
   page: 0,
   limit: 10,
   search: "",
}): string {
...
export async function searchExercises(params: SearchExercisesParams): Promise<ExercisesListResponse> {
